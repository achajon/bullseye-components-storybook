...
export const eventListWithLimitedItemsToDisplay: Story = {
  render: (args, { globals: { showInCard } }) => 
  <div className={showInCard === "Yes" ? "card shadow-sm p-3 mt-3" : ""}>
      <Events {...args} maxItemsToDisplay={1}/>
  </div>
}

export const eventListShowDatesInDescription: Story = {
  render: (args, { globals: { showInCard } }) => 
  <div className={showInCard === "Yes" ? "card shadow-sm p-3 mt-3" : ""}>
      <Events {...args} showDateLikeDescription={!args.showDateLikeDescription}/>
  </div>
}